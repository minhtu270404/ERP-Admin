    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: 'public/backend/src/assets/img/logo.svg',
                    lightLogo: 'public/backend/src/assets/img/logo2.svg'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', 'public/backend/src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
